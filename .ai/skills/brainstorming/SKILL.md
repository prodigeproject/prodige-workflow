...
6. **Write design doc** — save to `.ai/context/designs/YYYY-MM-DD-<topic>-design.md` and commit
...
- Write the validated design (spec) to `.ai/context/designs/YYYY-MM-DD-<topic>-design.md`
